...
public class UserController {
	...
	// http://localhost:8080/Users/Update
	   // userid=sea&oldpwd&passwd=12345&username=%EB%B0%94%EB%8B%A4&email=sea%40green.com
	   // Controller 에서 Map 으로 인자를 받을 때는 반드시 @RequestParam 을 사용해야한다
	@RequestMapping("/Update")
	public ModelAndView update( @RequestParam Map<String, Object> map ) {
		System.out.println("map" + map);
		// map{userid=user01, oldpwd=1234, passwd=12345, username=조민석, email=m_i_n_e@naver.com}
